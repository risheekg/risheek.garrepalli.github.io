...
**Hardware-first grounding.** Before ML: satellite fault-tree analysis (ISRO collaboration), then founding engineer on [Nino](https://sirenatech.com/nino/), a consumer humanoid robot, covering DoF allocation, static load analysis, EKF state estimation, and 3D-LIP gait control, from concept to walking prototype.
